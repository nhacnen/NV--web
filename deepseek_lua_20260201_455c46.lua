...
function Library:CreateWindow(title)
    ...
    function window:addTab(name)
        ...
        function tab:addSection(name)
            ...
            sectionFrame.Size = UDim2.new(1, 0, 0, 0) -- Height sẽ tự điều chỉnh
            ...
            -- Tự động điều chỉnh kích thước section
            local function updateSectionSize()
                local totalHeight = 25 -- Chiều cao tiêu đề
                for _, menu in ipairs(section.Menus) do
                    totalHeight = totalHeight + menu.Frame.Size.Y.Offset + 5
                end
            ...
            function section:addMenu(name)
                ...
                menuFrame.Size = UDim2.new(1, 0, 0, 200) -- Chiều cao mặc định
                menuFrame.Position = UDim2.new(0, 0, 0, self.MenuCount * 205)
                ...
                menuContent.Size = UDim2.new(1, 0, 1, -30)
                ...
                -- Tự động điều chỉnh kích thước menu
                local function updateMenuSize()
                    local totalHeight = 30 -- Chiều cao tiêu đề
                    for _, element in ipairs(menu.Elements) do
                        totalHeight = totalHeight + element.Size.Y.Offset + 5
                    end
                    menuFrame.Size = UDim2.new(1, 0, 0, totalHeight + 10)
                    updateSectionSize()
                end
                ...
                function menu:addButton(text, callback)
                    ...
                    button.Position = UDim2.new(0, 0, 0, self.ElementCount * 40)
                ...
                function menu:addToggle(text, defaultValue, callback)
                    ...
                    toggleFrame.Position = UDim2.new(0, 0, 0, self.ElementCount * 40)
                ...
                function menu:addTextbox(text, defaultValue, callback)
                    ...
                    textboxFrame.Position = UDim2.new(0, 0, 0, self.ElementCount * 65)
                ...
                function menu:addDropdown(text, defaultValue, options, callback)
                    ...
                    dropdownFrame.Position = UDim2.new(0, 0, 0, self.ElementCount * 65)
                ...
                function menu:addLabel(text)
                    ...
                    label.Position = UDim2.new(0, 0, 0, self.ElementCount * 30)
                ...
                function menu:addChangelog(text)
                    ...
                    changelogFrame.Size = UDim2.new(1, 0, 0, 60)
                    changelogFrame.Position = UDim2.new(0, 0, 0, self.ElementCount * 65)
